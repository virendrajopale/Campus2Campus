...
router.get('/registration_req', AuthenticateUser,restrictTo(["Admin","TPO_Admin","TPO_Dept_Admin"]), handleRegistrationReq);

//router:POST:/req_accept/:id:=> Accept Request of the user to register => Must login as department Admin
router.post('/req_accept/:id', AuthenticateUser, handleReqAcept);

//router:POST:/req_reject/:id:=> Reject Request of the user to register => Must login as department Admin
router.post('/req_reject/:id', AuthenticateUser,restrictTo(["TPO_Dept_Admin","Admin","TPO_Admin"]), handleReqReject);
