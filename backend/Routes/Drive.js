...
router.get('/getSelectedStu/:id',  handleGetSelectedStu)

//router:POST:/getStudents=>Fetch All the Student of the drive->Interested,Eligible,Selected => Must login as Admin
router.get('/getStudent/:cat/:id', AuthenticateUser, restrictTo(["TPO_Admin","Student"]), handleDriveStudent)
